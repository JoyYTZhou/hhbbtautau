...
def gen_jobs(groupname, jobdir, batch_size, babyjob_dirname):
    jl = JobLoader(datapath=pjoin(projectbase, 'data', jobdir), kwd=groupname, jobpath=pjoin(cwd, babyjob_dirname),
...
if __name__ == '__main__':
    ...
    argparser.add_argument('jobdir', type=str, help='Name of subdirectory under projectbase/data directory containing the meta json files to generate jobs')
    ...
    gen_jobs(args.groupname, args.batch, args.jobdir)