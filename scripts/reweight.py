...
def train_and_reweight_multiclass(data_df_0, mc_df, data_df_1, features, save_interval=None, n_epochs=80, batch_size=1024, lr=1e-3):
    """
...
def SSDataToOSQCD(ss_df, os_df, out_dir, training_args, session_name='', save_interval=None):
    ...
    results_dict = train_and_reweight_multiclass(ss_data, os_mc, os_data, features_train, save_interval=save_interval, **training_args)
